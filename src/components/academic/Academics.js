...
import { H2, H3, H4, Section, Tag } from '../ui'
...
// ── Stream Card ───────────────────────────────────────────────
function StreamCard({ icon, iconBg, iconColor, title, subjects }) {
  return (
    <div className="
...
export default async function AcademicsDetail() {
  ...
  return (
    <Section id="academics-detail" variant="default" className="flex flex-col gap-6 lg:gap-8">

      <H2 color="default" className="text-center">Academic Overview</H2>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 lg:gap-8 max-w-6xl mx-auto w-full">
