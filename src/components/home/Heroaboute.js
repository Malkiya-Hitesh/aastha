...
function Heroaboute() {
    return (
        <Section id="about" className="  flex flex-col items-center  gap-6 lg:gap-10">
            ...
            <div className='grid md:grid-cols-[1fr_2fr] gap-6 sm:gap-8 lg:gap-16  overflow-hidden'>


               
<div className='border-2 rounded-md mb-4 h-[250px] sm:h-[320px] md:h-full'>
  <img className="w-full h-full object-cover"   src="https://cdn.jsdelivr.net/gh/Malkiya-Hitesh/Aastha-image@main/image/4.webp"
              alt="About us" />
</div>
                ...
                <div className='flex flex-col items-start gap-6 lg:gap-10'>
                    ...
                    <div className='flex  gap-3 flex-col '>
                        <div className='flex gap-3 items-center'>
                            <div className='w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-[var(--color-green)]' />
                            <P color="muted" size="lg" style={{ fontWeight: 'bold' }}>Who we are</P>
                        </div>
                        <P size="md">
                    ...
                    <div className='flex  gap-3 flex-col'>
                        <div className='flex gap-3 items-center '>
                           <div className='w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-[var(--color-green)]' />
                            <P color="muted" size="lg" style={{ fontWeight: 'bold' }}>Our Values</P>
                        </div>
                        <P size="md">
                    ...
                    <div className='flex  gap-3 flex-col'>
                        ...
                        <div className='flex gap-3 items-center '>
                          <div className='w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-[var(--color-green)]' />
                            <P color="muted" size="lg" style={{ fontWeight: 'bold' }}>Our Vision</P>
